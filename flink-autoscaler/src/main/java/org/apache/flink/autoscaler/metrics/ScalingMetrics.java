...
import static org.apache.flink.autoscaler.ScalingMetricEvaluator.getAverage;
...
public class ScalingMetrics {
    ...
    public static void computeStateLatencyMetrics(
        ...
        var busyTimeMsPerSecond =
                busyTimeAggregator.get(flinkMetrics.get(FlinkMetric.BUSY_TIME_PER_SEC));
        var numRecordsInPerSecond = scalingMetrics.get(ScalingMetric.TRUE_PROCESSING_RATE);
